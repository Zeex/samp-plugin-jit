...
struct X86FuncDecl : public FuncDecl
{
  ...
  inline X86FuncDecl() ASMJIT_NOTHROW
  { reset(); }
  ...
  inline uint32_t getConvention() const ASMJIT_NOTHROW
  { return _convention; }

  //! @brief Get whether the callee pops the stack.
  inline uint32_t getCalleePopsStack() const ASMJIT_NOTHROW
  ...
  inline uint32_t getArgumentsDirection() const ASMJIT_NOTHROW
  ...
  //! @note This is related to used calling convention, it's not affected by
  //! number of function arguments or their types.
  inline const uint8_t* getGpList() const ASMJIT_NOTHROW
  { return _gpList; }
  ...
  //! @note This is related to used calling convention, it's not affected by
  //! number of function arguments or their types.
  inline uint32_t getGpPreservedMask() const ASMJIT_NOTHROW
  ...
  inline uint32_t getMmPreservedMask() const ASMJIT_NOTHROW
  ...
  //! @note This is related to used calling convention, it's not affected by
  //! number of function arguments or their types.
  inline uint32_t getXmmPreservedMask() const ASMJIT_NOTHROW
  ...
  ASMJIT_API uint32_t findArgumentByRegCode(uint32_t regCode) const ASMJIT_NOTHROW;
  ...
  ASMJIT_API void setPrototype(uint32_t convention, uint32_t returnType, const uint32_t* arguments, uint32_t argumentsCount) ASMJIT_NOTHROW;
